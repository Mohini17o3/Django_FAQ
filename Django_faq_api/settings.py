"""
Django settings for Django_faq_api project.
...
ROOT_URLCONF = 'Django_faq_api.urls'
...
WSGI_APPLICATION = 'Django_faq_api.wsgi.application'
...
if not DEBUG:
    ...
    admin_media = staticfiles_storage.url('admin/')
